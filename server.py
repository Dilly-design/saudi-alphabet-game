...
V2_SEEDS = {
    ...
    "ح": [("حمضيات","🍊",0), ("حنيذ","🍖",0)],
    "خ": [("خزامى","💜",0), ("خثاريد","🦎",0)],
    "د": [("الديرة","🏙️",0), ("دلة قهوة","☕",0), ("درباوي","🌿",0)],
    "ذ": [("ذهب","💛",0), ("ذبيحة","🐑",0)],
    "ر": [("رؤية","🔮",0), ("رياض","🏙️",0)],
    "ز": [("زعفران","🌸",0), ("زبيب","🍇",0), ("زمزم","💧",0)],
    "س": [("سعود","👑",0), ("سيفين","⚔️",0), ("سامري","🎵",0), ("سبحة","📿",0),
          ("سُمرة","🌅",0), ("سِدرة","🌳",0), ("سدو","🧶",0), ("سهيل","⭐",0)],
    "ش": [("شوال","🌙",0), ("شماغ","🧣",0), ("شاهي","🍵",0), ("شاص","🚙",0),
          ("شواية الخليج","🔥",0)],
    "ص": [("صامولي","🍞",0), ("صاروخ","🚀",0), ("صبّة","🫙",0),
          ("صقر","🦅",0), ("صملة","🪨",0)],
    "ض": [("ضبّ","🦎",0)],
    "ط": [("طن ططن","🥁",0), ("طعس","🎯",0), ("طيّب","🌸",0),
          ("طراطيع","🎭",0), ("طاق طاق طاقية","🎩",0), ("طويق","⛰️",0),
          ("طاش ما طاش","📺",0)],
    "ظ": [("ظبي","🦌",0), ("خالي من العيوب","⭐",0)],
    "ع": [("عصفر","🌺",0), ("عرضة","⚔️",0), ("عزبة","🏡",0)],
    "غ": [("غسال","🧺",0), ("غضى","🌳",0), ("غيبوبة العيد","💤",0)],
    "ف": [("فازلين","💆",0), ("فورد","🚗",0), ("فُلَّة","🌹",0), ("فوّال الطائف","🫘",0)],
    "ق": [("قلعة وادرين","🏰",0), ("قيظ","☀️",0), ("قايلة","😴",0)],
    "ك": [("كاسة جبن","🧀",0), ("كيرم","🎲",0)],
    "ل": [("لبيه","💛",0), ("لو قمت ولقيته","🚶",0)],
    "م": [("مخمّس","🎵",0), ("ماكنتوش","🍎",0), ("مربعانية","❄️",0),
          ("مقلط","🔑",0), ("مكة","🕌",0)],
    "ن": [("نعال","👡",0), ("نفط","🛢️",0), ("نخلة","🌴",0),
          ("نجد","🏜️",0), ("النيدو","🥛",0)],
    "هـ": [("هيل","🌿",0), ("هايلوكس","🚗",0), ("هبوب","💨",0)],
    "و": [("والله ما تدفع","💸",0), ("وانيت","🚌",0), ("ورع","🙏",0), ("ورد طائفي","🌹",0)],
    "ي": [("يصير خير","🌟",0), ("يُمّه","💛",0), ("يالالاه","🎵",0)],
}
